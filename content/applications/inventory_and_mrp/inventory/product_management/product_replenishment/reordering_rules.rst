...
.. important::
   ...
   reserves the product for the |SO| that caused it to be replenished. This means the product cannot
   be used for a different |SO|.
...
button to open the :guilabel:`Reordering Rules` page for the product. On the page, click
